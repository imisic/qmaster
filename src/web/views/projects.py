...
def _render_project_defaults(app: AppComponents) -> None:
    """Render the project defaults expander, absorbed from the old sidebar Settings."""
    with st.expander("Project Defaults", expanded=False):
        st.caption("These defaults apply to new projects unless overridden.")
